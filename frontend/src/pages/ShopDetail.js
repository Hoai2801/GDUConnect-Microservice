                    ...
                    <div class="py-3 sm:max-w-xl sm:mx-auto lg:min-w-full">
                        <div class="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg w-full border-t">
                            <div class="px-12 py-5">
                                <h2 class="text-gray-800 text-3xl font-semibold">Đánh giá sản phẩm!</h2>
                            </div>
                            <div class="bg-gray-200 w-full flex flex-col items-center">
                                ...
                                <div class="w-3/4 flex flex-col">
                                    <textarea rows="3" class="p-4 text-gray-500 rounded-xl resize-none" placeholder='Đánh giá của bạn'>Leave a message, if you want</textarea>
