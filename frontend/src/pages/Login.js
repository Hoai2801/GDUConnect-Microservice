      ...
      <section className="h-screen w-full bg-white">
        ...
        <div className="h-[90vh] flex login-box">
          ...
          <div className="flex flex-col justify-evenly pb-[10vh] max-w-[600px] w-full col-span-2 col-start-1 md:col-span-1 md:col-start-2">
            ...
            <div className="flex">
              <button className="py-4 px-[50px] ring-1 ring-black text-white bg-black rounded-[30px] hover:bg-white hover:text-black transition duration-300 mr-10">
                LOGIN
              </button>
              <button className="ring-1 ring-black bg-white py-4 px-[40px] rounded-[30px] hover:bg-black hover:text-white transition duration-300">
                FORGOT PASSWORD?
              </button>
            </div>
        ...
        {/* <div className="flex flex-col max-w-[600px]">
          <div className="flex justify-end h-[10vh] items-center pr-[5vh]"></div>
          <div className="flex flex-col h-[90vh] justify-around pb-[10vh]">
            <div>
              <h1 className="text-[30px] font-bold">Welcome Back!</h1>
              <p className="text-slate-600">Login to continue</p>
            </div>
